...
<div class="container py-3">
  ...
  <form action="{{ route("projects.store") }}" method="POST">
    ...
    <div class="mb-3">
      ...
      <!-- <input name="name" value="{{ old('name', 'Default') }}" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder=""> -->
    ...
    <div class="mb-3">
      ...
      <input name="image_url" value="{{ old('image_url') }}" type="text" class="form-control @error('image_url') is-invalid @enderror" id="image_url" placeholder="">
      @error('image_url')
      <div class="invalid-feedback">
